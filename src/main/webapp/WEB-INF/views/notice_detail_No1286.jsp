        ...
        <div class="container">
            ...
            <div class="align-items-center mt-4 wow fadeInLeft text-start mb-2 border-bottom border-dark ">
                <h2 class="text-black mb-3 fw-bold">
                    [플로리쉬입시컨설팅] 대입 입시컨설턴트 모집 
                </h2>
                <p class="d-inline text-black mb-5">
                    <span class="badge bg-secondary" style="font-size: 0.9em;">작성자 </span> 관리자
                </p>
                <p class="d-inline text-black mb-5">
                    &nbsp; <span class="badge bg-secondary" style="font-size: 0.9em;">등록일 </span> 2024-07-24
                </p>
                <p class="mb-4"></p>
            </div>
            <div class="row justify-content-center align-items-center mb-5">
                <h4 class="text-black my-3">
                    대입 입시 컨설턴트 모집 공고 (대치동 입시컨설팅 센터)
                </h4>
                <p class="text-black mb-2"></p>
                <br/>
                <p class="text-black mb-2"> <b>■ 회사명 :</b> FLOURISH CONSULTING</p>
                <p class="text-black mb-2"> <b>■ 직무명 :</b> 대학입시 비교과 컨설팅 </p>
                <p class="text-black mb-2"> <b>■ 우대조건 :</b> 경력 2년 이상 </p>
                <p class="text-black mb-2"> <b>■ 학력 :</b> 대졸이상 </p>
                <p class="text-black mb-3 fw-bold"> ■ 담당업무</p>
                <p class="text-black mb-2">- 비교과 입시컨설팅(이공계, 자연과학 전공자 우대)</p>
                <p class="text-black mb-2">- 단순히 진로진학 컨설팅 업무가 아닌, 비교과에 대한 전반적인 컨설팅이 가능한 자</p>
                <p class="text-black mb-2"></p>
                <a href="https://www.flourish-con.com">대표 홈페이지</a>
            </div>
